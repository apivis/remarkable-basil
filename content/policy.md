...
This privacy policy explains how we (APIVIS) collect, use, share and transfer your personal data when you use the services provided on apivis.com (“our sites”) and our related mobile applications (“our apps”).
...
The data controller for our sites and apps is dataprotection@apivis.com. This means that we are responsible for deciding how and why we hold and use your personal data. If you want to contact us, you can find our contact details in the “How to contact us” section below.
...
The personal data we collect when you register for a APIVIS account

When you register for a Apivis account on apivis.com we collect:

- your name;
- your email address;
- some limited data from your social media profile (further information on this is below) if you have signed in to apivis.com using your social media details; and

- your photograph, if you add one to your profile page.

You can choose to add a nickname to your profile page and you can use this when posting content or comments on our site.

When you register for a Apivis account, we assign you a unique ID number that we use to recognise you when you are signed in to our services. This will recognise you if you sign in using the same account on a new device or through a different application such as Apivis app on mobile devices.
...
Signing up for membership may also mean you need to provide other details such as your address details:
...
Using your social media details to sign into your Apivis account
...
We will then use this information to form a profile for your Apivis account. If you remove Apivis app from your Facebook settings, or if you remove Apivis from your Google settings, we will no longer have access to this data. However, we will still have the information that we received when you first set up your Apivis account using your Facebook or Google login.
...
- To provide the services you sign up for, such as sending out email. We also use the personal data for related internal administrative purposes - such as our accounting and records - and to make you aware of any changes to our services.
...
- To sell advertising space on our sites. Since the development of the very first version of the Apivis.com site on 16 April 2020, our work has been funded in part by advertising. Today, digital advertising underpins much of our investment in high quality services.
...
- Access permissions that we ask from users of Apivis app

When you use Apivis app, we ask for the following permissions to access particular functions of your mobile device:

- For the SPA version, we ask for permission to access your contact details/profile on your mobile device, so that we can add or find your Apivis account on your phone. We also ask for permission to access the storage on your mobile device, so that you can store content and read when offline.

- We also ask for permission to save pictures to your photo library, so that you can save pictures that you take on your mobile device.
...
When you register for an account with Apivis, you have access to a profile page. Under “profile” you can review what information is public when you comment in our articles, or if people look up your profile. You can also update your information or provide extra information if you want in ”settings”.
...
When you register or book a ticket for a Apivis event organised by an event partner, your registration data may be shared with us by the event partner.
...
Depending on where you live, we may share your personal data with Apivis’s group of companies currently based in Sweden. For example, if you book an event held in Stockholm, at first we may hold your data on our systems in the HQ and then we may share it with Apivis in Stockholm for administration purposes.
...
Sometimes we may receive a letter, email or another form of communication from you that we consider to be significant to the history of Apivis. We may decide to share this with Apivis Archive run by Apivis Foundation for historic and archiving purposes.
...
From time to time we may send you service emails, for example, thanking you when you contribute or place an order with us.

Marketing communications and newsletters

If we have your permission, we may send you materials we think may interest you, such as new Apivis offers and updates. Depending on your marketing preferences, this may be by email, phone, SMS or post.

You can decide not to receive these emails at any time and will be able to “unsubscribe” directly by clicking a link in the email or through your email preferences in the tab “Emails and marketing” when you are signed in to your Apivis account.

Market research

Sometimes we may contact you for market research purposes, for example about a survey. You can opt out from being contacted in this way by signing into your Apivis account and going to the section “Emails and marketing”.
...
We use personalised online advertising on our sites. This allows us to deliver more relevant advertising to people who visit Apivis.com. It works by showing you adverts that are based on your browsing patterns and the way you have interacted with our sites and apps. It then shows you adverts which we believe may interest you.

Since the development of the very first version of the Apivis Single Page App on 16 April 2020, our work has been funded in part by advertising. Our editorial content is not influenced by the advertising we display and our editors are free to, and often do, challenge the activities of companies and organisations that advertise and sponsor content that appears in Apivis sites.
...
We may also share online data collected through cookies and similar technology with our advertising partners. This means that when you are on another website, you may be shown advertising based on your browsing patterns on Apivis. We may also show you advertising on Apivis.com website based on your browsing patterns on other sites that we have obtained from our advertising partners.
...
- If you do not want us to use your personal data for marketing analysis, you can change your settings in the “Emails and marketing” tab of your Apivis account.

- If you want to make any of these requests, please contact dataprotection@Apivis.com.

We may need to request specific information from you to help us confirm your identity.

Your California privacy rights
Under California Civil Code Section 1798.83, if you live in California and your business relationship with us is mainly for personal, family or household purposes, you may ask us about the information we release to other organisations for their marketing purposes. To make such a request, please send an email to dataprotection@Apivis.com with “Request for California privacy information”in the subject line. You may make this type of request once every calendar year. We will email you a list of categories of personal data we revealed to other organisations for their marketing purposes in the last calendar year, along with their names and addresses. Not all personal data shared in this way is covered by Section 1798.83 of the California Civil Code.

Contact us for information about how we use your personal data
If you have any questions about how we use your personal data or if you have a concern about how your personal data is used, please contact the Data Protection Officer at Apivis email dataprotection@Apivis.com.

Complaints will be dealt with by the Data Protection Manager, and will be responded to within 30 days.

If you have a question about anything else, please see our Contact page.
...
April 2020: Removed irrelevant information.

Since you’re here...
… we're asking users like you to contribute to support of our open, independent app. In these frightening and uncertain times, the expertise, scientific knowledge and careful judgment in our reporting have never been so vital.  The future feels unpredictable, but we will remain with you, delivering high quality services so we can all make critical decisions about our lives, health and security. Together we can find a way through this.

We believe every one of us deserves equal access to reliable information and a calm explanation. So, unlike many others, we made a different choice: to keep Apivis open for all, regardless of where they live or what they can afford to pay. It would not be possible without the generosity of users, who now support our work from around the world.

We have upheld our independence in the face of the disintegration of media – with social platform groups being shut down, the seemingly unstoppable rise of big tech and independent voices being squashed by commercial ownership. Apivis's independence means we can set our own agenda and voice our own opinions. Our site is free from commercial and political bias – never influenced by billionaire owners or shareholders. This makes us different. It means we can challenge the powerful without fear and give a voice to those less heard.

We need your support so we can keep delivering quality services that are open and independent. And that is here for the long term. Every user's contribution, however big or small, is so valuable. Support Apivis from as little as €1 – and it only takes a minute. Thank you! :-)
